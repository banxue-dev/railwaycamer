...
function execIsBottom() {
	if ($('#showCheckList').attr("checked") == 'checked') {
		$('#endStationName').attr('readonly', 'readonly').attr('placeholder',
				'点击选择站点');
		$('#stationCode').attr('readonly', 'readonly').attr('placeholder',
				'点击选择站点');
		$('#staPys').attr('readonly', 'readonly').attr('placeholder', '点击选择站点');
		...
		$('#endStationName').removeAttr('readonly').attr('placeholder',
				'请输入站点名称');
